...
eStreaming API is a fully managed solution that processes, stores and distributes all Travelport shopping data among users with a very simple and easy to use JSON API interface.
