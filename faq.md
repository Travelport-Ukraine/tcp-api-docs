...
Currently we process all data that Travelport sends us from following markets "AE", "AF", "AL", "AS", "AT", "AZ", "BA", "BY", "CZ", "DE", "EE", "FI", "FR", “HR”, "HU", "ID", "IE" ,"IT", "JP", "LT", "LV", "MD", "MK", "NL", "NZ", "PK", "PL", "RO", "RS", "RU", "SK", "SZ", "UA", "US", "ZA". Feel free to use any from this list in your requests. Historical data available for “CZ”, “PL”, “UA” markets for 3 month.
