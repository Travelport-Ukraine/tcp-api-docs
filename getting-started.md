...
3. Import into Postman the CEE-Cache-Production-collection. json file containing the necessary default settings and Auth token. See [Using Postman](/using-postman.md) for more details about transmitting eStreaming API request and retrieving data.
